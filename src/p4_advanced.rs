...
pub fn new_basic(initial_address: Ipv4Addr)->(BasicModule, AsyncGateway<IPMessage>, TestingSender){
...
impl P4Advanced {
    pub fn new(
        hub: Option<Box<dyn AsyncChannel<ChannelEvent>>>,
        basic: Option<Box<dyn AsyncChannel<ChannelEvent>>>,
    ) -> Self {
